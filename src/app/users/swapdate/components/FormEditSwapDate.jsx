...
function FormEditSwapDate({ id }) {
  ...
  console.log("🚀 ~ FormEditSwapDate ~ editProjectAction:", editProjectAction);
  const [editActionDate, setEditActionDate] = useState([]);
  const [editSwapDate, setEditSwapDate] = useState([]);
  ...
  const { trigger, isMutating } = useUpdateSwapDate(id);
...
export default FormEditSwapDate;
