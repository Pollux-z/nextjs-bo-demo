...
import { CiPen, CiCoffeeCup, CiApple, CiBowlNoodles } from "react-icons/ci";
      ...
      <div className="">
        <div className="relative max-w-2xl grid grid-cols-2">
          <div className="m-auto">
            <CiPen size={100} className="text-gray-300" />
          </div>
          <div className="mt-6 border-l-4 border-dotted px-4">
            ...
            <h5 className="mt-2 font-semibold">Intern 1</h5>
        ...
        <div className="relative max-w-2xl grid grid-cols-2">
          <div className="text-right px-5">
            ...
            <h5 className="mt-2 font-semibold">Intern 2</h5>
            <p className="text-sm text-gray-500">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius
              repudiandae aliquid doloribus accusamus assumenda quam eos quia
              quo, cum voluptates delectus cumque, magnam reprehenderit quis!
          ...
          <div className="mt-6 border-l-4 border-dotted flex justify-center items-center">
            <CiCoffeeCup size={100} className="text-gray-300" />
          </div>
        </div>

        <div className="relative max-w-2xl grid grid-cols-2">
          <div className="m-auto">
            <CiApple size={100} className="text-gray-300" />
          </div>
          ...
          <div className="mt-6 border-l-4 border-dotted px-4">
            ...
            <h5 className="mt-2 font-semibold">Intern 3</h5>
            <p className="text-sm text-gray-500">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius
              repudiandae aliquid doloribus accusamus assumenda quam eos quia
              quo, cum voluptates delectus cumque, magnam reprehenderit quis!
        ...
        <div className="relative max-w-2xl grid grid-cols-2">
          <div className="text-right px-5">
            ...
            <h5 className="mt-2 font-semibold">Intern 4</h5>
            <p className="text-sm text-gray-500">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius
              repudiandae aliquid doloribus accusamus assumenda quam eos quia
              quo, cum voluptates delectus cumque, magnam reprehenderit quis!
          ...
          <div className="mt-6 border-l-4 border-dotted flex justify-center items-center">
            <CiBowlNoodles size={100} className="text-gray-300" />
          </div>
        </div>
      </div>
    </>
