...
function ProjectLostCard() {
  return (
    <Card>
      <h3 className="text-sm">Lost Project</h3>
      <h3 className="text-2xl mt-5">22 Project</h3>
      <div className="flex items-center space-x-2">
        <GoArrowUpLeft
          size={15}
          className="bg-red-100 rounded-full text-red-600 h-6 w-6"
        />
        <p className="text-xs">+15% last year</p>
      </div>
...
export default ProjectLostCard