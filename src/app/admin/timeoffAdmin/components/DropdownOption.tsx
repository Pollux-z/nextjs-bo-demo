...
import BtnDeleteAdminTimeOff from "./BtnDeleteAdminTimeOff";

export default function DropdownOption({ id }: { id: number }) {
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <div className="py-1">
          <MenuItem>
            <a
              href={`/admin/timeoffAdmin/edit/${id}`}
